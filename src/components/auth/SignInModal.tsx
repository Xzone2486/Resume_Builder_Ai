    ...
    <AnimatePresence>
      {showModal && (
        <>
          ...
          >
            <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-indigo-500/10 border border-zinc-100 pointer-events-auto overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  {mode === "signup" && (
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full h-11 pl-10 pr-4 rounded-xl border border-border bg-zinc-50 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 transition-all"
                      />
                    </div>
                  )}
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full h-11 pl-10 pr-11 rounded-xl border border-border bg-zinc-50 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 transition-all"
                    />
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["Google", "GitHub"].map((provider) => (
                    <button
                      ...
                      className="flex items-center justify-center gap-2 h-10 rounded-xl border border-border bg-white hover:bg-zinc-50 text-sm font-medium transition-all hover:shadow-sm"
                    >
                      {provider === "Google" ? (
